...
if(isset($_POST['continue'])) {
    ...
    if ($email == $row["email"]) {
         ...
         echo "<script>alert('Incorrect Email ID.'); window.location.href='pass_process.php';</script>";
}
?>
<html lang="en">
...
<!--Login Form Start-->
   ...
   <div class="loginform">
      ...
      <form action="#" method="Post">
         <div><h5><b><i> For New Password...</i></b></h5></div>
         <div>
            <label for="">Email :</label>
            <input type="username" id="username" placeholder="Email" name="email" required/>
         </div>
         <button class="button" name="continue">Continue</button>
